...
urlpatterns = [
    ...
    path('<int:pk>/', include([
        ...
        path('forms/', include([
            ...
            path('editor/<str:form_key>/', views.SubscriptionFormTemplateUpdateView.as_view(),
                 name='edit_form_template'),
            path('editor/<str:form_key>/preview/', views.PreviewFormTemplateView.as_view(),
                 name='preview_form_template'),
        ])),
